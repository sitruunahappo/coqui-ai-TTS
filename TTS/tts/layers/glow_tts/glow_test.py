...
from TTS.tts.layers.generic.wavenet_test import WN
...
class CouplingBlock(nn.Module):
    ...
    def __init__(
        ...
        self.end = end
        # coupling layers
        self.wn = WN(hidden_channels, hidden_channels, kernel_size, dilation_rate, num_layers, c_in_channels, dropout_p, pitch_size)

    def set_pitch_size(self, pitch_size):
